                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group focused">
                        ...
                        <input id="input-address" class="form-control form-control-alternative" placeholder="Home Address" value="1,2 Rue André Ampère, Pole Technologique El Ghazela" type="text" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row">
