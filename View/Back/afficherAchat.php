							...
							<div>
								...
								<div class="module-body">
									...
									<table class="table table-striped table-bordered table-condensed" style="border-collapse: collapse;"  width='100%' id="myTable" >
										<thread>
											<tr>
												<th onclick="sortTableNum(0)" width='5%' >idClient</th>
												<th onclick="sortTableNum(1)" width='5%' >idSpectacle</th>
												<th onclick="sortTableNum(2)" width='5%' >prixTotal</th>
												<th width='30%' >dateAchat</th>
												<th width='30%' >adresseEmail</th>
												<th onclick="sortTableNum(5)" width='5%' >nbrePlaces</th>
												<th width='30%'>Opérations</th>
											</tr>
										</thread>
										<tbody>
											...
											<tr>
												...
												<td width='30%' style="text-align: center;">
													...
													<form method="POST" action="ajouterReservation.php">
                                                        <input type="submit" class="btn-info" name="Réserver" value="Réserver">
                                                        <input type="hidden" value=<?php echo $Achat['idAchat']; ?> name="idAchat">
                                                    </form>
                                                    <a href="supprimerAchat.php?idAchat=<?php echo $Achat['idAchat']; ?>"><button class="btn-danger">Supprimer</button></a>
                                                </td>
											</tr>
                                            <?php
                                                }
