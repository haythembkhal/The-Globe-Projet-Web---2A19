<?php
    ...
    if(
        ...
        if (
            ...
            $ReservationC->modifierReservation($Reservation, $_POST['idReservation']);
	...
	<div class="wrapper">
		<div class="container">
			<div class="row">
				...
				<div class="span9">
					<div class="content">
                    <button class="btn"><a href="afficherAchat.php">Retour à la liste des Reservations</a></button>
                    <div id="error">
                        <?php echo $error; ?>
                    </div>
                    <?php
                            if (isset($_POST['idReservation'])){
                                $Reservation = $ReservationC->recupererReservation($_POST['idReservation']);
                            }
                    ?>
                    <hr>
						<div class="module">
                            <div>
                                ...
                                <div>
                                    <form name="formModifier" class="form-horizontal row-fluid" onsubmit="return validateForm()" action="" method="POST">
                                        <br>
                                        <div class="module-head">
                                            <h3>Achat :</h3>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="idAchat" placeholder="Veuillez saisir l'ID Client" class="span8" name="idAchat" value="<?php echo $Reservation['idAchat']; ?>">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="numSiege" placeholder="Veuillez saisir le numéro de siège" class="span8" name="numSiege" value="<?php echo $Reservation['numSiege']; ?>">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <input type="submit" class="btn-success" id="btnModifier" value="Modifier">
                                    ...
                                    <script>
                                        ...
                                        {
                                            var idAchat= document.forms["formModifier"]["idAchat"].value;
                                            var numSiege= document.forms["formModifier"]["numSiege"].value;
											...
											try{
												...
												document.getElementById('errornumSiege').innerHTML=err;
											}
