<?php
    ...
    if(
        ...
        if (
            ...
            $AchatC->modifierAchat($Achat, $_POST['idAchat']);
                                ...
                                <div>
                                    <form name="formModifier" class="form-horizontal row-fluid" onsubmit="return validateForm()" action="" method="POST">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <input type="number" id="prixTotal" placeholder="0.000" class="span8" min="0" name="prixTotal" value="<?php echo $Achat['prixTotal']; ?>"><span class="add-on">DT</span>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="date" id="dateAchat" class="span8" name="dateAchat" value="<?php echo $Achat['dateAchat']; ?>">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="email" id="adresseEmail" placeholder="abc123@exemple.com" class="span8" name="adresseEmail" value="<?php echo $Achat['adresseEmail']; ?>">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="number" id="nbrePlaces" step="1"  placeholder="0" class="span8" name="nbrePlaces" value="<?php echo $Achat['nbrePlaces']; ?>">
