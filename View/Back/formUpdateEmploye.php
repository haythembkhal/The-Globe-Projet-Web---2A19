...
$count=$notification->nouvelleNotification();//recupérer les nouvelles notifications
 ...
 //update
     if (isset($_POST['update']))
	 {
		 ...
		 $employe_modification=$emp->rechercherEmploye($userID);
		 //var_dump($employe_modification);
		 //die;
		
		 //header('location:table_utilisateurs.php');
		 //var_dump($userID);
		 //die;
		 foreach($employe_modification as $e)
	 {
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" action="modifierEmploye.php" method="POST" onsubmit="return verif()">
										<div class="control-group">
											<label class="control-label" for="basicinput">FirstName</label>
											<div class="controls">
												<input type="text" id="firstname" placeholder="Type firstname here..." class="span8" value=<?php echo $firstname;?> name="first">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="lastname" placeholder="Type lastname here..." class="span8" value=<?php echo $lastname;?> name="last">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="username" placeholder="Type username here..." class="span8"value=<?php echo $username;?> name="user">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="mail" id="email" placeholder="Type mail here..." class="span8"value=<?php echo $email;?> name="mail">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="password" id="password" placeholder="Type password here..." class="span8" value=<?php echo $password;?> name="pass">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="password" id="passwordConfim" placeholder="Type password here..." class="span8">
										...
										<div class="control-group">
											<div class="controls">
											<input type="hidden" name="update1" value=<?php echo $userID; ?>>
											
											<a href="table_utilisateurs.php"><button class="btn-success">Annuler</button></a>
											<input type="submit"  class="btn-success" name="Modifier">
