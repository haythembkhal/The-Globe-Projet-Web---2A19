        ...
        <div>
		  ...
		  <p id="spectacleTitle" class="spectacleInfo spectacleHeader"> <b> <?php echo $titre; ?></b> </p>
			<p id="spectacleTime" class="spectacleInfo "> <ion-icon name="time-outline"></ion-icon> <?php echo $duree; ?></p>
              ...
              <a id="spectacleLocation" style="color:black;"class="spectacleInfo" href="#map"><ion-icon name="airplane-outline"></ion-icon><?php echo $adresse ?></a> 
...
<section>
    ...
    <h3 class="spectacleHeader">Leave a Comment</h3>
	<br>
    <form action="post_comment.php" method="post" id="commentform">
      ...
      <label for="email" id="emailName" class="required">Email: </label>
  ...
  <aside>
    <div>
		<p class="spectacleHeader" id='textImageComment' >Les Commentaires Ci-Bas ! Cliquez !</p> 
        <a href="google.com">
			<img src="<?php echo $imgportrait; ?>" alt="img" style="width:20%;" id="commentaireImage">

		</a>        
       
        <!-- je mets cette option a cote de la saisie des commentaires -->
        <!-- je vais ouvrir une fenetre ici pour les commentaires -->
        <button id="thumbsUp">	 Pourcentage Liked </button>
        <button  id="thumbsDown"> Pourcentage Disliked</button>
      </div>
  </aside>
</section>
	</section>
