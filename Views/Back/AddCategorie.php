							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="AddCategorie" method="post" action="" onsubmit="return Verif()">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" placeholder="Type something here..." class="span8" name="nomartiste">
												<p id="errorNR" class="error"></p>
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea type="text" id="basicinput" placeholder="Type something here..." class="span8" name="nationalite"></textarea>
												<p id="errorPR" class="error"></p>
