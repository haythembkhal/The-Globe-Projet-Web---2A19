...
<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light fill px-lg-0 py-0 px-3">
				<div class="container">
					<a class="navbar-brand" href="#index.html">
								<img src="C:/xampp/htdocs/Artistes/Views/Front/logob.png" alt="Your logo" title="Your logo" style="height:50px;" />
							</a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item active">
								<a class="nav-link" href="about.html">Artistes</a>
							</li>
							<li class="nav-item">
						...
						<div class="search-right">
							<a href="#search" class="btn search-hny mr-lg-3 mt-lg-0 mt-4" title="search">rechercher un Artiste <span
	...
	<div class="w3l-breadcrumbs">
		<nav id="breadcrumbs" class="breadcrumbs">
			...
			<a href="index.html">Home</a> » <span class="breadcrumb_last" aria-current="page">Artistes</span>
			</div>
		</nav>
	</div>
 <!--//breadcrumbs -->
			...
			<div class="grids-main py-5">
				<div class="container py-lg-4">
					<div class="headerhny-title">
						<h3 class="hny-title">Vos Artistes préféreés</h3>
					</div>
					<div class="owl-team owl-carousel owl-theme">
						<div class="item vhny-grid">
							<div class="d-grid team-info">
								<div class="column position-relative">
									<a href="#url"><img src="assets/images/kev.jpg" alt="" class="img-fluid rounded team-image" /></a>
								</div>
								<div class="column text-center">
									<h3 class="name-pos"><a href="#url">Kev Adams</a></h3>
						...
						<div class="item vhny-grid">
							<div class="box16">
								<div class="d-grid team-info">
									<div class="column position-relative">
										<a href="#url"><img src="assets/images/Gims.jpg" alt="" class="img-fluid rounded team-image" /></a>
									</div>
									<div class="column text-center">
										<h3 class="name-pos"><a href="#url">Gims</a></h3>
						...
						<div class="item vhny-grid">
							<div class="box16">
								<div class="d-grid team-info">
									<div class="column position-relative">
										<a href="#url"><img src="assets/images/1p.jpg" alt="" class="img-fluid rounded team-image" /></a>
									</div>
									<div class="column text-center">
										<h3 class="name-pos"><a href="#url">Thomas Ngijol</a></h3>
