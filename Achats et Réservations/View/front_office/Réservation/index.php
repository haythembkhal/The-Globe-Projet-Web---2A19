...
<body>
<div class="content">
	<h1>Achtez vos tickets :</h1>
	<div class="main">
		<h2>Réservation :</h2>
		<div class="demo">
			<div id="seat-map">
				<div class="front">Scène</div>					
			</div>
			<div class="booking-details">
				...
				<ul class="book-right">
					<li>: Concert Yüma</li>
					<li>: 08 Avril, 09:00</li>
					<li>: <span id="counter">0</span></li>
					<li>: <b><span id="total">0</span></b><i>DT</i></li>
				</ul>
				<div class="clear"></div>
				<ul id="selected-seats" class="scrollbar scrollbar1"></ul>
			
						
				<button class="checkout-button">Acheter</button>	
				<div id="legend"></div>
			</div>
					...
					var sc = $('#seat-map').seatCharts({
						...
						click: function () { //Click event
							if (this.status() == 'available') { //optional seat
								$('<li>Ligne '+(this.settings.row+1)+' Siège '+this.settings.label+'</li>')
